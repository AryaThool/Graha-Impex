...
export default function CertificatesClient() {
  ...
  const certificates = [
    ...
    },
    {
      ...
      image: "https://sagobctjwpnpmpcxxyut.supabase.co/storage/v1/object/public/certificate-images/822050_apeda_agricultural-processed-food-products-export-development-authority-india.png",
      validUntil: "2025",
    ...
    },
    {
      ...
      image: "https://sagobctjwpnpmpcxxyut.supabase.co/storage/v1/object/public/certificate-images/spices-board-india-regional-office-gummidipundi-chennai-ministry-of-commerce-a0c525.jpg",
      validUntil: "2025",
    ...
    },
    {
      ...
      fullName: "Phytosanitary Certificate for Export",
      authority: "Plant Quarantine Division, Directorate of Plant Protection, Quarantine & Storage (DPPQS), Government of India",
      description: "An official certificate issued to ensure that plants, plant products, and agricultural commodities being exported are free from quarantine pests and conform to the importing country’s phytosanitary requirements.",
      image: "https://sagobctjwpnpmpcxxyut.supabase.co/storage/v1/object/public/certificate-images/photosanitary.png",
      validUntil: "Varies by shipment",
      registrationNumber: "SB/EXP/2021/5678",
      issuedDate: "2021",
      category: "Export Compliance",
      importance: "Mandatory for export of plants, plant products, and agricultural commodities",
      benefits: [
        "Ensures compliance with international plant health standards",
    "Prevents shipment rejection at destination port",
    "Builds trust with international buyers",
    "Facilitates smooth cross-border trade of agricultural goods",
      ],
      color: "green",
      priority: 8,
    },
    {
      ...
      fullName: "Fumigation & Pest Control Treatment Certificate",
      authority: "Accredited Fumigation Agencies approved by the Plant Quarantine Authority of India",
      description: "An official certificate confirming that the exported goods, packaging material, or containers have been fumigated to eliminate pests and comply with importing country phytosanitary standards.",
      image: "https://sagobctjwpnpmpcxxyut.supabase.co/storage/v1/object/public/certificate-images/fugmentation.webp",
      validUntil: "Valid for one shipment",
      registrationNumber: "SB/EXP/2021/5678",
      issuedDate: "2021",
      category: "Export Compliance",
      importance: "Mandatory for export shipments requiring pest-free packaging or goods",
      benefits: [
        "Ensures cargo is free from pests",
    "Prevents rejection or quarantine at the destination port",
    "Meets international phytosanitary and packaging standards",
    "Enhances acceptance of agricultural and wooden-packaged goods",
      ],
      color: "orange",
      priority: 9,
    },
    {
      ...
      fullName: "Certificate of Origin (COO)",
      authority: "Export Inspection Council (EIC) / Chamber of Commerce / Government-approved Agencies.",
      description: "An official document certifying that the exported goods are produced, manufactured, or processed in a specific country. Required to determine import duties, trade benefits, and eligibility under trade agreements.",
      image: "https://sagobctjwpnpmpcxxyut.supabase.co/storage/v1/object/public/certificate-images/eic.jpg",
      validUntil: "Valid for the specific shipment",
      registrationNumber: "SB/EXP/2021/5678",
      issuedDate: "2021",
      category: "Trade Documentation",
      importance: "Mandatory for international trade under most customs regulations",
      benefits: [
         "Required for customs clearance at destination",
    "Enables reduced or zero import duty under trade agreements",
    "Authenticates origin of goods",
    "Prevents shipment delays or rejection",
      ],
      color: "blue",
      priority: 10,
    },
